        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center align-items-center">
                ...
                @endif
                    ...
                    <h3 class="py-8 text-center">Forgot Password?</h3>
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="POST" action="{{route('forgot')}}">
                        @csrf
                        ...
                        <div class=" d-flex justify-content-end"><button class="btn btn-primary text-uppercase mr-left w-full" id="submitButton" type="submit">Send</button></div>
