            ...
            <div class="container px-4 px-lg-5">
                ...
                @endif
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Want to update your blog?</p>
                        <div class="my-5">
                            <form id="blogForm" action="{{ route('updateblog', ['id'=> $content->id]) }}" method="POST">
                                @csrf
                                <div class="form-floating">
                                    <input class="form-control" id="name" name="name" type="text"
                                        placeholder="Enter your name..." data-sb-validations="required" value="{{$content->name}}"/>
                                    <label for="name">Name</label>
                                    <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" id="email" name="email" type="email"
                                        placeholder="Enter your email..." data-sb-validations="required,email" value="{{$content->email}}"/>
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="title" name="title" type="text"
                                        placeholder="Enter title..." data-sb-validations="required,title" value="{{$content->title}}"/>
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" id="blog" name="blog" placeholder="Enter your blog here..." style="height: 12rem"
                                        data-sb-validations="required">{{$content->blog}}</textarea>
