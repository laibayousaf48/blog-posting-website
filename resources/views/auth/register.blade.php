        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center align-items-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <h3 class="py-8 text-center">Create an Account</h3>
                    <form id="contactForm"  method="POST" action="{{route('registerSave')}}">
                        @csrf
                        ...
                        <div class="form-floating">
                            <input class="form-control" id="password" name="password" type="password" placeholder="Enter your password here..." data-sb-validations="required"></input>
                            <label for="password">Password</label>
                            <div class="invalid-feedback" data-sb-feedback="password:required">A password is required.</div>
                        </div>
                        <div class="form-floating">
                            <input class="form-control" type="password" id="password_confirmation" name="password_confirmation" placeholder="Confirm your password here..." data-sb-validations="required"></input>
                        ...
                        <a class="fs-6 d-flex  my-3" href="{{route('login')}}">Already have an account? Log In</a>
                    </form>
                </div>
            </div>
        </div>
